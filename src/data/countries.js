export const COUNTRIES = [
  ...
  'Nicaragua','Nigeria','North Macedonia','Norway','Oman','Pakistan','Palestine',
...
export const REGIONS = [
  ...
  'North Africa','Sub-Saharan Africa','Western Europe','Eastern Europe',
  'Northern Europe','Southern Europe','North America','Central America',
  'South America','Caribbean','Oceania','Pacific Islands',
];

export const COUNTRIES_AND_REGIONS = [...REGIONS, ...COUNTRIES];