      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <div className="flex items-center justify-between pt-3 border-t border-[#F0EBE3] gap-3 flex-wrap">
          <div className="min-w-0">
            ...
            {post.price && (
              <p className="text-xs font-bold mt-0.5 text-[#1A1A1A]" >
                {post.price}
              </p>
            )}
          </div>
          ...
          <div className="flex items-center gap-2 flex-wrap justify-end">
            ...
            {hasExternal && (
              <a href={externalUrl} target="_blank" rel="noreferrer"
                className="flex items-center gap-1.5 text-xs font-bold px-4 py-2 rounded-xl text-black bg-[#F5FDA6] hover:bg-[#3E3D38] transition-colors">
